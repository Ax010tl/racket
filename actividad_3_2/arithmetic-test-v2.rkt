...
(define test-arithmetic-lexer
    (test-suite
        ...
        (check-equal? (arithmetic-lexer "2+1") '(("2" int) ("+" operador) ("1" int)) "Binary operation ints")
        (check-equal? (arithmetic-lexer "5.2+3") '(("5.2" float) ("+" operador) ("3" int)) "Float and int")
        (check-equal? (arithmetic-lexer "5.2+3.7") '(("5.2" float) ("+" operador) ("3.7" float)) "Binary operation floats")
        (check-equal? (arithmetic-lexer "2 + 1") '(("2" int) ("+" operador) ("1" int)) "Binary operation with spaces")
        (check-equal? (arithmetic-lexer "6 = 2 + 1") '(("6" int) ("=" operador) ("2" int) ("+" op) ("1" int)) "Multiple operators with spaces")
